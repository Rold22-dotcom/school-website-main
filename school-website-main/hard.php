...
$typeuser = null;
if (isset($_SESSION['kid-name']) && $_SESSION['kid-name']) {
    $typeuserjs = json_encode($_SESSION['kid-name']);
} else {
    $typeuserjs = json_encode($typeuser);
}
...
<body loading="lazy">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <img src="img/giphy.gif" alt="Tama ang sagot" width="200px" height="200px" loading="lazy">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="container mt-5">
            ...
            <?php
            // question for normalmode
            $scorehave = 0;
            $quizquestion = [
                [
                    "question" => "Ano ang nasa larawan ?",
                    "img" => "img/ball.jpg",
                    "choices" => ["Bola", "Ball", "Laruan", "Bolla"],
                    "answer" => 0 // Correct answer index (A)
                ],
                [
                    "question" => "Ano ang nasa larawan ?",
                    "img" => "img/pineapple.png",
                    "choices" => ["piña", "pineapple", "Paaralan", "Nag aaral"],
                    "answer" => 0
                ],
                [
                    "question" => "Ano ang nasa larawan ?",
                    "img" => "img/pic3.jpg",
                    "choices" => ["mga bata", "bata", "paaralan", "nag aaral"],
                    "answer" => 0
                ]
            ];
            ...
            <div class="position-absolute top-50 start-50 translate-middle d-grid gap-2">
                ...
                <img id="img" src="" class="text-center" width="400px" height="150px">
            ...
            <div class="position-absolute bottom-0 start-0"><button class="button-back rounded" id="backmenu" onclick="back()">back</button></div>
            ...
            <script>
                ...
                const playmusicfailed = new Audio('music/error.mp3');
                ...
                function ajaxrecord() {
                    const usertype = <?= $typeuserjs ?>; // Define usertype using PHP variab
                    if (usertype != null) {
                        const hardmode = "hard";
                        const data = {
                ...
                $('#failed_modal').on('hidden.bs.modal', function() {
                    document.activeElement.blur(); // Remove focus from the modal
                });
            </script>
